...
export function normalizePermissionResponse(response: unknown): PermissionResponse {
...
export function resolveExpoProjectId(constants: unknown): string | undefined {
