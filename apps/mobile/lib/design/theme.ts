...
export const color = {
  ...
  actionPrimary: chit.graphite,
  actionPrimaryPressed: chit.charcoalRaised,
  onActionPrimary: chit.surface,
  uiAccent: chit.acidLime,
  uiAccentSoft: chit.acidLimeSofter,
  onUiAccent: chit.charcoal,
  accent: chit.stampCoral,
  accentSoft: chit.stampCoralSoft,

  bg: chit.matteCharcoal,
  surface: chit.offWhiteElevated,
  surfaceSunken: chit.offWhiteSubtle,
  surfaceSoft: chit.offWhite,
  shell: chit.matteCharcoal,
  shellElevated: chit.charcoalElevated,
  shellRaised: chit.charcoalRaised,
  shellHighest: chit.graphite,
  ...
  textOnShell: chit.surface,
  textOnShellMuted: 'rgba(252,252,248,0.72)',
  textOnShellFaint: 'rgba(252,252,248,0.52)',
  textLink: chit.fintechBlue,
  primaryTextOnLight: chit.charcoal,

  borderSubtle: chit.offWhiteBorder,
  borderDefault: chit.offWhiteBorder,
