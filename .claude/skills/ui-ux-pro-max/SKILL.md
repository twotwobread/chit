...
Source:
.harness/skills/ui-ux-pro-max/SKILL.md
...
Commands below are shown relative to this skill directory. When working from the repository root, run the script from the active adapter path instead:

- Pi: `python3 .pi/skills/ui-ux-pro-max/scripts/search.py ...`
- Claude: `python3 .claude/skills/ui-ux-pro-max/scripts/search.py ...`
- Agents: `python3 .agents/skills/ui-ux-pro-max/scripts/search.py ...`
